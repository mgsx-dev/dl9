...
// XXX copy paste from church inside : TODO refactor
public class PlacePhase extends BaseActionPhase {
	...
	public PlacePhase(GameLevel level) {
		super(level);
		emittersUnused = level.mobManager.findEmitters("Empty.place");
